class Exercise:
    ...
    def current_mass(self):
        total_mass = sum(weight.mass * weight.in_use for weight in self._weights)
        return total_mass + self._bar_mass

    def max_mass(self):
        total_mass = sum(weight.mass * weight.count for weight in self._weights)
        return total_mass + self._bar_mass
...
def load_exercises():
    ...
    for weight in my_object['_weights']:
        weights.append(Weight(weight['_mass'], weight['_count'], weight['_inUse']))
